...
<head>
  ...
  <style>
    *{ font-family: DejaVu Sans, Arial, Helvetica, sans-serif; font-size: 10px; }
    h1,h2,h3{ margin:0; }
    .wrap{ width: 100%; }
...
<body>
  <div class="wrap">
    ...
    <div class="row">
      <div class="box" style="width:58%">
        ...
        <span class="small">
          ...
          <?php if(!empty($order['customer_email'])): ?> · <?=h($order['customer_email'])?><?php endif; ?>
        </span>
      </div>
    ...
    <table>
      <thead><tr><th style="width:28%">Tanggal</th><th style="width:35%">Metode/Jenis</th><th class="right">Nominal</th></tr></thead>
      <tbody>
        <?php if(!$payments): ?>
          <tr><td colspan="3" class="small">Belum ada pembayaran.</td></tr>

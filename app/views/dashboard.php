...
<div class="row g-3 mt-1">
    ...
    <div class="card shadow-sm">
      ...
      <div class="card-body p-0">
        <table class="table table-sm mb-0">
          <thead><tr><th>#</th><th>Pelanggan</th><th>Produk</th><th>Qty</th><th>Deadline</th><th>Status</th><th></th></tr></thead>
          <tbody>
          <?php if (!$near): ?>
            <tr><td colspan="7" class="text-muted small p-3">Tidak ada.</td></tr>
  ...
  <div class="col-lg-6">
    <div class="card shadow-sm">
      ...
      <div class="card-body p-0">
        <table class="table table-sm mb-0">
          <thead><tr><th>Tanggal</th><th>Pelanggan</th><th>Produk</th><th class="text-end">Nominal</th></tr></thead>
          <tbody>
          <?php if (!$recentPay): ?>
...
<script>
  ...
  new Chart(document.getElementById('chartOrders'), {
    type: 'line',
    data: { labels: ordersLabels, datasets: [{ label: 'Order', data: ordersData, tension:.3 }] },
    options: { plugins:{legend:{display:false}}, scales:{y:{beginAtZero:true}} }
  });

  new Chart(document.getElementById('chartRevenue'), {
    type: 'line',
    data: { labels: revLabels, datasets: [{ label: 'Rp', data: revData, tension:.3 }] },
    options: { plugins:{legend:{display:false}}, scales:{y:{beginAtZero:true}} }
  });
</script>
